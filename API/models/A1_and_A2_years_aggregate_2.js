...
// 定義A1_and_A2_112_year_aggregate_2的Schema
// Schema是一個用來定義文檔結構的描述
const A1_and_A2_years_aggregate_2_Schema = new mongoose.Schema({
...
// 'A1_and_A2_years_aggregate_2' 是模型名稱，通常用作MongoDB集合的名稱（會自動轉換為小寫並複數化）
// A1_and_A2_years_aggregate_2_Schema 是該模型對應的Schema
// 'A1_and_A2_years' 是指定的MongoDB集合名稱，這樣可以避免自動轉換
module.exports = mongoose.model('A1_and_A2_years_aggregate_2', A1_and_A2_years_aggregate_2_Schema, 'A1_and_A2_years');
